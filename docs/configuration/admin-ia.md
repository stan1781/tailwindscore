...
| IA Concern | Current Label | Canonical Owner | Lifecycle |
| --- | --- | --- | --- |
...
| --- | --- | --- |
| admin IA mapping | retained | compact reference |
| admin language prose | archived | historical reference |
| legacy bucket language | prohibited | no reintroduction |

## Canonical Reference Index

- preset boundaries: `docs/presets/preset-boundaries.md`
- content governance: `docs/content-surfaces/content-surface-rules.md`
- documentation rules: `docs/governance/documentation-rules.md`
